...
pub const TESTNET_EXPLORER: &str = "https://explorer.tondi.org";
pub const DEVNET_EXPLORER: &str = "https://explorer.tondi.org";
...
impl Core {
    ...
    pub fn new(
        ...
        #[cfg(not(target_arch = "wasm32"))]
        if settings.node.tondid_daemon_storage_folder_enable {
            storage.track_storage_root(Some(settings.node.tondid_daemon_storage_folder.as_str()));
        }
    ...
    pub fn select_with_type_id(&mut self, type_id: TypeId) {
        ...
        if self.module.type_id() != module.type_id() {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            {
                ...
                crate::runtime::services::tondi::update_logs_flag()
